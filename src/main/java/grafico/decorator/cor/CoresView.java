...
import grafico.decorator.cor.SeletorCoresButton.ColorChangedListener;
...
final class CoresView extends JDialog {
    ...
    public void addBotaoCores() {
        ...
        colorChooser = new SeletorCoresButton(Color.WHITE);
        ...
        colorChooser2 = new SeletorCoresButton(Color.BLUE);
    ...
    private SeletorCoresButton colorChooser;
    private SeletorCoresButton colorChooser2;

    public SeletorCoresButton getColorChooser() {
        return colorChooser;
    }

    public SeletorCoresButton getColorChooser2() {
