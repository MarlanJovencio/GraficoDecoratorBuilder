...
import grafico.decorator.GradesDecorator;
...
public final class PrincipalPresenter {
    ...
    public PrincipalPresenter() throws CloneNotSupportedException, IOException {
        carregaDados = new CarregaDados("src/main/dados/pessoas.csv", ",", "sexo");
